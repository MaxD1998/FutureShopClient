...
export class ProductBaseListComponent implements OnDestroy {
  ...
  columns: DataTableColumnModel[] = [
    {
      field: 'name',
      headerText: 'product-module.product-base-list-component.name',
      template: TableTemplate.text,
    },
    {
      field: 'categoryName',
      headerText: 'product-module.product-base-list-component.category-name',
      template: TableTemplate.text,
    },
    {
      field: 'productCount',
      headerText: 'product-module.product-base-list-component.product-count',
      template: TableTemplate.text,
    },
    {
      field: 'actions',
  ...
  changePage(pageNumber: number): void {
    this._router.navigateByUrl(
      `${ClientRoute.productModule}/${ClientRoute.productBase}/${ClientRoute.list}/${pageNumber}`,
    );
  }

  navigateToCreate(): void {
    this._router.navigateByUrl(`${ClientRoute.productModule}/${ClientRoute.productBase}/${ClientRoute.form}`);
  }

  navigateToEdit(id: string): void {
    this._router.navigateByUrl(`${ClientRoute.productModule}/${ClientRoute.productBase}/${ClientRoute.form}/${id}`);
  }
